...
<li><a  class="active" href="entry.php">Entry_List</a></li>
...
<a href="../../logout.php">Log Out <i class="ti-shift-left"></i></a>
  ...
  <div class="main_content_iner ">
    ...
    <h3 class="mb-0">Latest Revisit Visitor Data </h3>
    </div>
    </div>
<div style="overflow-x:auto;">
  <table>
    ...
    <?php
                ...
                $sql= "SELECT * FROM khatta_timestamp  order by sno desc";
...
$schedule_date = new DateTime($timestamp, new DateTimeZone('UTC') );
...
$triggerOn =  $schedule_date->format('Y-m-d H:i:s');
                   echo "
                    ...
                    <td>
                    <a class='button1 button4' href='view.php?id=$row[id]'>View</a>
