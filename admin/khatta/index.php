...
// SQL query to fetch only one line
$sql = "SELECT * FROM khatta_timestamp   order by sno desc LIMIT 1";
...
<div >
<h3><span>khatta</span> </h3>
<p></p>
</div>
</div>
<div class="single_quick_activity d-flex">
<div class="icon">
<img src="img/icon/registered.png" alt="registered">
</div>
...
<tbody>
    <?php
             require_once '../dbcon.php'; 
                ...
                $sql= "SELECT * FROM registration where site='khatta'";
...
<a class='dropdown-item' href='profile.php?phone_number=$row[phone_number]'>View</a>
